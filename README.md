...
📘 [Official Server Setup Docs](https://docs.fivem.net/docs/server-manual/setting-up-a-server-vanilla/)
...
1. Download Menyoo from:
   ...
   * 🌐 <a href="https://www.gta5-mods.com/scripts/menyoo-2-0#comments_tab">GTA5-Mods - Menyoo 2.0</a>
...
* To change the menu toggle key, refer to the Virtual Key Codes table:
  ...
  * ⌨️ [View Key Codes](https://cherrytree.at/misc/vk.htm)
